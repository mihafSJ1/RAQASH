...
<meta charset="utf-8">
   ...
   <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
    ...
    <link rel="stylesheet" type="text/css" href="CSS/viewArtWork2.css">
...
<div class = "container" id="viewArt">
    ...
    <div class="right">
        <div class=" date">
            <label class = "title2"> <span id = "dot">•</span><?php echo $viewArt['Title']?><span id = "dot">•</span> </label>
        ...
        <div class="artist">
            <a href="<?php echo 'ArtistSudioVistor.php?id='.$viewArt['Artist_username']?>"id="userName"><?php echo $viewArt['Artist_username']?></a>
        </div>
        <div class="comments">
