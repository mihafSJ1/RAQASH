        ...
        <header class="menu-bar">
                <nav>
                    <ul>
                        ...
                        <li id ="Gsize"><a href="logout.php">LOG OUT</a></li>
            ...
            <div class="account">
                    ...
                    <div class ="addCardbox">
                        <div id="addCard" >
                            <div class ="right">
                              <div class ="uploadbox">
                                ...
                                <form id="addArtwork" name="addArtwork"action="AddArtwork.php" method ="post" enctype="multipart/form-data">
                             ...
                             <div class ="left">
                         <div>
                         <input type="button" value=&#10799 class="colse" id="close1">
                               <div class ="formbox">
                        ...
                        <div class="col-md-6 text-center">
                            ...
                            <h5 class="username"><?php echo"Username: ".$username;?></h5>
                                <h5 class="name"><?php echo"Name: ".$bio['name'];?></h5>
                          
                              <h5 class="bio2"> <?php echo"Bio: ".$bio['bio'];?> </h5>
