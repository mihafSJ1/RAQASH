...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="CSS/ManageArtwork2.css">
...
<?php 
    ...
    $id = $_GET['id'];
    $SQLupdateArtwork = "SELECT * FROM ArtWork WHERE AId ='$id'";
    ...
    <div class="container">
      <div class="right">
        ...
        <input type="hidden" name="action" value="<?php echo $id ?>" /> 
          ...
          <img  id ="imageUpdated" src=<?php echo "images/".$img?> width="300px" height="300px" >
